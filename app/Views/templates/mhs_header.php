...
<head>
    ...
    <title><?= isset($page_title) ? $page_title ." | " : "" ?>List Mahasiswa</title>
    <!-- Styles -->
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url() ?>">List Mahasiswa</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?= base_url('main/mhs') ?>"><i class="fa fa-th-list"></i> List</a>
                    </li>
                    <?php if(session('logged_in')){?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('main/mhs_create') ?>"><i class="fa fa-plus-square"></i> Add New</a>
                        </li>
                    <?php }?>
                </ul>
            </div>
            <?php if(!session('logged_in')){?>
                <a href="<?= base_url("/main/login")?>" class="text-light fw-bold text-decoration-none">Login</a>
            <?php } else {?>
                <a href="<?= base_url("/auth/logout")?>" class="text-light fw-bold text-decoration-none">Logout</a>
            <?php }?>
        </div>
    </nav>
